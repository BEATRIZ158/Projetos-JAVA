...
@WebServlet(name = "EscolaExcluir", urlPatterns = {"/EscolaExcluir"})
public class EscolaExcluir extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (dao.excluir(idEscola)){
                mensagem = "Escola excluído com sucesso!";
            }else {
                mensagem = "Problemas ao axcluir Escola";
            }
            request.setAttribute("mensagem", mensagem);
            response.sendRedirect("EscolaListar");
        }catch (Exception ex) {
            System.out.println("Problemas no Servlet ao excluir Escola! Erro:"+ex.getMessage());
            ex.printStackTrace();
        }
    }
